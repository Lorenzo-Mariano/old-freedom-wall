...
import { fetchMyPosts, getPosterId, deletePost } from "./async.js"
...
const postsData = (await fetchMyPosts(sessionStorage.getItem('currentUser')))[0]
if (postsData.length > 0) {
	...
	noPostsNotif.innerText = 'No posts to show'
